...
export class RegisterBillingCutsUsecase implements UseCasePromise<RegisterBillingCut, number> {
    ...
    execute(billingCuts: RegisterBillingCut): Promise<ResponseData<number>> {
        ...
        return this._billingCutRepository.registerBillingCuts(billingCuts)
    }
}